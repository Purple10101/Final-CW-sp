##############################################################################################################################################
#   Filename:       CircResultsExporter.py
...
#                   Support for both dB and linear displays in the same output is now active!
#
...
class CircResultsExporter:
    ...
    """
    Class with argument attributes as the instance of the circuit in question and
    the list of ordered parameters.

    :def to_standard_form:
        Converts a number into a standard form string representation.

        :param x: float - The number to convert.
        :return: str - The number in standard form as a string.

    :def export_to_csv:
        Collates all the circuit information and formats it, ready to be exported to a CSV file.

        :param File_path: str - The path where the CSV file will be saved.
        :param circuit_instance: circuit - The instance of the circuit to export.
        :return: None - Outputs a CSV file to the specified directory.
    """
    ...
    def export_to_csv(self, file_path):
        ...
        for F in self.circuit.Freq:
            ...
            for param, unit in self.ordered_parameters.items():
                ...
                # This is for accepting invalid output requests
                try:
